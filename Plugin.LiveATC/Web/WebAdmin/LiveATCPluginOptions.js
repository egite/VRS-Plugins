...
if(!VRS.WebAdmin.LiveATCPluginOptions) VRS.WebAdmin.LiveATCPluginOptions = {};

VRS.WebAdmin.LiveATCPluginOptions.PageHandler = function(viewId) {
    var self = this;
    self._ViewId = new VRS.WebAdmin.ViewId('LiveATCPluginOptions', viewId);
    self._Model = null;
    self.refreshState();
};

VRS.WebAdmin.LiveATCPluginOptions.PageHandler.prototype.showFailureMessage = function(message) {
...
VRS.WebAdmin.LiveATCPluginOptions.PageHandler.prototype.refreshState = function() {
    var self = this;
...
VRS.WebAdmin.LiveATCPluginOptions.PageHandler.prototype.save = function() {
    var self = this;
...
VRS.WebAdmin.LiveATCPluginOptions.PageHandler.prototype.buildAjaxSettingsForSendConfiguration = function() {
    var self = this;
...
VRS.WebAdmin.LiveATCPluginOptions.PageHandler.prototype.applyState = function(state) {
    var self = this;
    if(state.Exception) {

...
if(!VRS.WebAdmin.PilotsViewPluginOptions) VRS.WebAdmin.PilotsViewPluginOptions = {};

VRS.WebAdmin.PilotsViewPluginOptions.PageHandler = function(viewId) {
    var self = this;
    self._ViewId = new VRS.WebAdmin.ViewId('PilotsViewPluginOptions', viewId);
    self._Model = null;
    self.refreshState();
};

VRS.WebAdmin.PilotsViewPluginOptions.PageHandler.prototype.showFailureMessage = function(message) {
...
VRS.WebAdmin.PilotsViewPluginOptions.PageHandler.prototype.refreshState = function() {
    var self = this;
...
VRS.WebAdmin.PilotsViewPluginOptions.PageHandler.prototype.save = function() {
    var self = this;
...
VRS.WebAdmin.PilotsViewPluginOptions.PageHandler.prototype.buildAjaxSettingsForSendConfiguration = function() {
    var self = this;
...
VRS.WebAdmin.PilotsViewPluginOptions.PageHandler.prototype.applyState = function(state) {
    var self = this;
    if(state.Exception) {

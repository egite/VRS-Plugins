...
if(!VRS.WebAdmin.TileServerMBTilesPluginOptions) VRS.WebAdmin.TileServerMBTilesPluginOptions = {};

VRS.WebAdmin.TileServerMBTilesPluginOptions.PageHandler = function(viewId) {
    var self = this;
    self._ViewId = new VRS.WebAdmin.ViewId('TileServerMBTilesPluginOptions', viewId);
    self._Model = null;
    self.refreshState();
};

VRS.WebAdmin.TileServerMBTilesPluginOptions.PageHandler.prototype.showFailureMessage = function(message) {
...
VRS.WebAdmin.TileServerMBTilesPluginOptions.PageHandler.prototype.refreshState = function() {
    var self = this;
...
VRS.WebAdmin.TileServerMBTilesPluginOptions.PageHandler.prototype.save = function() {
    var self = this;
...
VRS.WebAdmin.TileServerMBTilesPluginOptions.PageHandler.prototype.buildAjaxSettingsForSendConfiguration = function() {
    var self = this;
...
VRS.WebAdmin.TileServerMBTilesPluginOptions.PageHandler.prototype.applyState = function(state) {
    var self = this;
    if(state.Exception) {

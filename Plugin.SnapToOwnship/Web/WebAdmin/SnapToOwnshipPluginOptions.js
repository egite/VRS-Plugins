...
if(!VRS.WebAdmin.SnapToOwnshipPluginOptions) VRS.WebAdmin.SnapToOwnshipPluginOptions = {};

VRS.WebAdmin.SnapToOwnshipPluginOptions.PageHandler = function(viewId) {
    var self = this;
    self._ViewId = new VRS.WebAdmin.ViewId('SnapToOwnshipPluginOptions', viewId);
    self._Model = null;
    self.refreshState();
};

VRS.WebAdmin.SnapToOwnshipPluginOptions.PageHandler.prototype.showFailureMessage = function(message) {
...
VRS.WebAdmin.SnapToOwnshipPluginOptions.PageHandler.prototype.refreshState = function() {
    var self = this;
...
VRS.WebAdmin.SnapToOwnshipPluginOptions.PageHandler.prototype.save = function() {
    var self = this;
...
VRS.WebAdmin.SnapToOwnshipPluginOptions.PageHandler.prototype.buildAjaxSettingsForSendConfiguration = function() {
    var self = this;
...
VRS.WebAdmin.SnapToOwnshipPluginOptions.PageHandler.prototype.applyState = function(state) {
    var self = this;
    if(state.Exception) {

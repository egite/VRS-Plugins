...
if(!VRS.WebAdmin.DeselectAircraftPluginOptions) VRS.WebAdmin.DeselectAircraftPluginOptions = {};

VRS.WebAdmin.DeselectAircraftPluginOptions.PageHandler = function(viewId) {
    var self = this;
    self._ViewId = new VRS.WebAdmin.ViewId('DeselectAircraftPluginOptions', viewId);
    self._Model = null;
    self.refreshState();
};

VRS.WebAdmin.DeselectAircraftPluginOptions.PageHandler.prototype.showFailureMessage = function(message) {
...
VRS.WebAdmin.DeselectAircraftPluginOptions.PageHandler.prototype.refreshState = function() {
    var self = this;
...
VRS.WebAdmin.DeselectAircraftPluginOptions.PageHandler.prototype.save = function() {
    var self = this;
...
VRS.WebAdmin.DeselectAircraftPluginOptions.PageHandler.prototype.buildAjaxSettingsForSendConfiguration = function() {
    var self = this;
...
VRS.WebAdmin.DeselectAircraftPluginOptions.PageHandler.prototype.applyState = function(state) {
    var self = this;
    if(state.Exception) {

...
if(!VRS.WebAdmin.MissingLogosPluginOptions) VRS.WebAdmin.MissingLogosPluginOptions = {};

VRS.WebAdmin.MissingLogosPluginOptions.PageHandler = function(viewId) {
    var self = this;
    self._ViewId = new VRS.WebAdmin.ViewId('MissingLogosPluginOptions', viewId);
    self._Model = null;
    self.refreshState();
};

VRS.WebAdmin.MissingLogosPluginOptions.PageHandler.prototype.showFailureMessage = function(message) {
...
VRS.WebAdmin.MissingLogosPluginOptions.PageHandler.prototype.refreshState = function() {
    var self = this;
...
VRS.WebAdmin.MissingLogosPluginOptions.PageHandler.prototype.save = function() {
    var self = this;
...
VRS.WebAdmin.MissingLogosPluginOptions.PageHandler.prototype.refreshLogs = function() {
    var self = this;
    self._ViewId.ajax('RefreshLogs', {
        success: function(data) {
...
VRS.WebAdmin.MissingLogosPluginOptions.PageHandler.prototype.buildAjaxSettingsForSendConfiguration = function() {
    var self = this;
...
VRS.WebAdmin.MissingLogosPluginOptions.PageHandler.prototype.applyState = function(state) {
    var self = this;
    if(state.Exception) {

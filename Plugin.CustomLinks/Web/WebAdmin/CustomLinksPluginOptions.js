...
if(!VRS.WebAdmin.CustomLinksPluginOptions) VRS.WebAdmin.CustomLinksPluginOptions = {};

VRS.WebAdmin.CustomLinksPluginOptions.PageHandler = function(viewId) {
    var self = this;
    self._ViewId = new VRS.WebAdmin.ViewId('CustomLinksPluginOptions', viewId);
    self._Model = null;
    self.refreshState();
};

VRS.WebAdmin.CustomLinksPluginOptions.PageHandler.prototype.showFailureMessage = function(message) {
...
VRS.WebAdmin.CustomLinksPluginOptions.PageHandler.prototype.refreshState = function() {
    var self = this;
...
VRS.WebAdmin.CustomLinksPluginOptions.PageHandler.prototype.save = function() {
    var self = this;
...
VRS.WebAdmin.CustomLinksPluginOptions.PageHandler.prototype.addLink = function() {
    var self = this;
    self._Model.Links.push(ko.viewmodel.fromModel({
        Name: '',
        Url: '',
        ConditionPrefix: ''
    }));
...
VRS.WebAdmin.CustomLinksPluginOptions.PageHandler.prototype.removeLink = function(link) {
    var self = this;
    self._Model.Links.remove(link);
};

VRS.WebAdmin.CustomLinksPluginOptions.PageHandler.prototype.buildAjaxSettingsForSendConfiguration = function() {
    var self = this;
...
VRS.WebAdmin.CustomLinksPluginOptions.PageHandler.prototype.applyState = function(state) {
    var self = this;
    if(state.Exception) {

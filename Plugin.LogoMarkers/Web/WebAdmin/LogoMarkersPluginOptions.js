...
if(!VRS.WebAdmin.LogoMarkersPluginOptions) VRS.WebAdmin.LogoMarkersPluginOptions = {};

VRS.WebAdmin.LogoMarkersPluginOptions.PageHandler = function(viewId) {
    var self = this;
    self._ViewId = new VRS.WebAdmin.ViewId('LogoMarkersPluginOptions', viewId);
    self._Model = null;
    self.refreshState();
};

VRS.WebAdmin.LogoMarkersPluginOptions.PageHandler.prototype.showFailureMessage = function(message) {
...
VRS.WebAdmin.LogoMarkersPluginOptions.PageHandler.prototype.refreshState = function() {
    var self = this;
...
VRS.WebAdmin.LogoMarkersPluginOptions.PageHandler.prototype.save = function() {
    var self = this;
...
VRS.WebAdmin.LogoMarkersPluginOptions.PageHandler.prototype.buildAjaxSettingsForSendConfiguration = function() {
    var self = this;
...
VRS.WebAdmin.LogoMarkersPluginOptions.PageHandler.prototype.applyState = function(state) {
    var self = this;
    if(state.Exception) {
